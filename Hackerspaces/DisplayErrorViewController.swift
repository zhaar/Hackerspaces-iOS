...
A: You will need a server that exposes a public API. Once your API is up and running you can register it's address at the OpenSpace directory  (https://github.com/fixme-lausanne/OpenSpaceDirectory) by making a pull request. Once the pull request is accepted your Hackerspace will be visible in the app.
